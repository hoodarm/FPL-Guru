...
1.  Budget constraint: The total value of the squad must not exceed £100 million.
2.  Club constraint: A maximum of 3 players can be chosen from a single Premier League club.
3.  Positional constraint: The squad must be made of 15 players, consisting of 2 goalkeepers (GK), 5 defenders (DF), 5 midfielders (MF), and 3 forwards (FW)
